...
BEGIN
	...
	IF NOT EXISTS (SELECT 1 FROM FuncKeyMapped WHERE CharacterID = @NewCharacterID)
	BEGIN
	  INSERT INTO FuncKeyMapped(CharacterID, FKMValue)
	  VALUES(@NewCharacterID, 0x2A01400E3D004700EA0300004902D0ED2D004F02558C1E005102518C1E00520286841E005301EA030000);
	END;
